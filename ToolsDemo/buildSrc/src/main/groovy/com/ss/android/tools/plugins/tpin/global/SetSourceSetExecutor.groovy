...
class SetSourceSetExecutor extends BaseExecutor{
     ...
     * 添加到SourceSet中
     **/
    void includeIntoSourceSet(Project project, String flavor = "main", TPinModuleModel... sourceSets) {
        includeIntoSourceSet(project, flavor, TPinUtils.variableParamsToList(sourceSets))
    }

    void includeIntoSourceSet(Project project, String flavor = "main", Iterable<TPinModuleModel> sourceSets) {
     ...
     * 从sourceSet中移除
     **/
    void excludeFromSourceSet(Project project, String flavor = "main", TPinModuleModel... sourceSets) {
        excludeFromSourceSet(project, flavor, TPinUtils.variableParamsToList(sourceSets))
    }

    void excludeFromSourceSet(Project project, String flavor = "main", Iterable<TPinModuleModel> sourceSets) {
        AndroidSourceSet obj = getProjectSourceSet(project, flavor)
        sourceSets.each {
            def set = it.mAndroidSourceSet
